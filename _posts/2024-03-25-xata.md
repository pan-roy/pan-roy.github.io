...
To insert data into our database, use the following Python script:
...
As you can see, our query has correctly displayed the natural account description to the relevant account codes and projects - all from our newly created 24/7 live database.

## Outcome

This obviously is a simplified example of a database setup, but with the proper database design planning and execution, complex databases with various calculated fields and logic built in can be used for advanced reporting and analytics. We will explore these in future walkthroughs.